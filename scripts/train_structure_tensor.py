...
def get_model(
    ...
    m = StructureTensorModel(**model_hparams)
    ...
    model = StructureTensorLitModule(
        m,
...
def main(config: dict):
    ...
    # load from checkpoint
        ...
        model = load_model(
            StructureTensorModel, StructureTensorLitModule, restore_checkpoint
        )
    print(model)
...
if __name__ == "__main__":
    ...
    config_file = Path(__file__).parent / "configs" / "config_structure_tensor.yaml"
