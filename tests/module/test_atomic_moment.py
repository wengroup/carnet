...
from carnet.module.atomic_moment import AtomicMoment, AtomicMoment2
...
def test_AtomicMoment2(config_info):
    coords, atom_type, edge_vector, edge_idx, num_atoms, num_atom_types = config_info
    ...
    am = AtomicMoment2(F, L1, L2, L3, num_atom_types, num_average_neigh=1.0)
    out = am(edge_vector, edge_idx, atom_type, x)
